...
class CrudController extends ManagementAppController 
{
	...
	public function isAuthorized($user = null) {
		...
		if (in_array($class, Configure::read('Management.ignoreModels'))) {
	...
	protected function overrideAction($action, $id = null) {
		$overrides = Configure::read('Management.actionOverrides');
	...
	protected function overrideView($action) {
		$overrides = Configure::read('Management.viewOverrides');
		$model = $this->Model->qualifiedName;
